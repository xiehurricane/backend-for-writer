package com.yzzh.forwritter.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("backendForWriter");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("backendForWriter");
        ...
        config.getMapConfigs().put("com.yzzh.forwritter.domain.*", initializeDomainMapConfig(jHipsterProperties));
